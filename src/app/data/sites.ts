export const sites = {
  ...
  utahmountainadventures: {
    ...
    paths: [
      ...
      "/backountry-courses/",
      "/private-backcountry-skiing-splitboarding/",
      "/private-hiking-backpacking-snowshoeing/",
      "/private-ice-climbing/",
      "/private-mountaineering/",
      "/private-rock-climbing-canyoneering/",
      "/calendar/",
      "/privacy-policy/",
      ...
      "/avalanche-education/",
      "/ice-climbing-gear/",
      "/winter-spring-mountaineering-gear/",
      "/summer-fall-mountaineering-gear/",
      "/rock-climbing-canyoneering-gear/",
      "/hiking-backpacking-snowshoeing-gear/",
      "/about/",
      "/where-we-guide/",
      "/gear-lists-local-rentals/",
      "/backcountry-avalanche-gear/",
      "/lodging-trailheads-directions/",
      "/faq/",
      "/guides/",
      "/all-courses/",
      "/private-guiding/",
